...
//    final shoppingCartItem = Provider.of<CartItemProvider>(context);
    return Opacity(
      opacity: widget.product.isAvailable == 1 &&
              ...
              widget.product.quantity <= widget.product.availableQuantity
          ? 1.0
          : 0.3,
      child: Container(
                              ...
                              GestureDetector(
                                onTap: widget.product.isAvailable == 1 &&
                                    ...
                                    ? () async {
                                        ...
                                        minQty(widget.product.quantity);
                                      }
                                    : null,
                                child: Container(
                                  width: 30.0,
                              ...
                              GestureDetector(
                                onTap: widget.product.isAvailable == 1 &&
                                    ...
                                    ? () async {
                                        ...
                                        addQty(widget.product.quantity);
                                      }
                                    : null,
                                child: Container(
                                  width: 30.0,
